...
class BlogRepositoryImpl implements BlogRepository{
  ...
  BlogRepositoryImpl(this.blogLocalDataSource, this.connectionChecker,  this.blogRemoteDataSource);

  @override
  Future<Either<Failure, Blog>> uploadBlog({required File image, required String title, required String content, required String posterId, required List<String> topics}) async{
   try{
